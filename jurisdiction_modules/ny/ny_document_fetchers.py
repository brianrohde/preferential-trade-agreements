...
def fetch_tier_3(ruling_id: str, cache_dir: str, jurisdiction: str = "ny") -> Tuple[str, str, Dict]:
    """
    ...
    Args:
        ruling_id: CBP ruling identifier
        cache_dir: Directory for caching artifacts
        jurisdiction: Jurisdiction code (e.g. "ny", "ca") used in the download URL
    ...
    for year in YEAR_CANDIDATES:
        url = DOC_URL_TEMPLATE.format(jurisdiction=jurisdiction, year=year, ruling_id=ruling_id)
...
def fetch_ruling_text(ruling_id: str, cache_dir: str, tier: int = 3, jurisdiction: str = "ny") -> Tuple[str, str, Dict]:
    """
    ...
    Args:
        ...
        jurisdiction: Jurisdiction code (e.g. "ny", "ca"), used by tier 3
    ...
    if tier == 1:
        ...
        return fetch_tier_3(ruling_id, cache_dir, jurisdiction=jurisdiction)
    else:
