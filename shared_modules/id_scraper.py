...
def harvest_range(
    ...
    Ruling data (one JSONL line per ruling) is appended to ruling_data_path:
      input_data/{collection_lower}/ruling_ids/{collection_lower}_ruling_ids_scraper.jsonl
    ...
    if ruling_data_path is None:
        ruling_data_path = Path(f"input_data/{collection_lower}/ruling_ids/{collection_lower}_ruling_ids_scraper.jsonl")
